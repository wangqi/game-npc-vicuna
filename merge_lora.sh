...
#LORA_WEIGHT="${2:-"#LORA_WEIGHT="${2:-"ziqingyang/chinese-llama-plus-lora-7b,ziqingyang/chinese-alpaca-plus-lora-7b,Facico/Chinese-Vicuna-lora-7b-3epoch-belle-and-guanaco"}",models/chinese_alpaca_plus_lora_7b,Facico/Chinese-Vicuna-lora-7b-3epoch-belle-and-guanaco"}"
MODEL_PATH="${3:-"models/huggyllama_chinese-alpaca-plus-lora-7b"}"
OUT_TYPE="f16"
