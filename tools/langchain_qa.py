...
parser.add_argument('--file_path', required=False, default="", type=str)
parser.add_argument('--embedding_path', required=False, default="shibing624/text2vec-base-chinese", type=str)
...
if __name__ == '__main__':
    ...
    model = LlamaCpp(model_path=model_path, verbose=True, **model_kwargs)
