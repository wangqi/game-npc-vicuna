...
echo python -m gptq.llama ./models/$MODEL_PATH c4 --wbits 4 --true-sequential --act-order --save_safetensors ./models/$MODEL_PATH/gptq-4bit-128g.safetensors
CUDA_VISIBLE_DEVICES=0 python -m gptq.llama ./models/$MODEL_PATH c4 --wbits 4 --true-sequential --act-order \
  --save_safetensors ./models/$MODEL_PATH/gptq-4bit-128g.safetensors
